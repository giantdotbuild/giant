...
fn draw_help_overlay(frame: &mut Frame, area: Rect) {
    ...
    let lines = vec![
        ...
        Line::from(""),
        Line::from("  Build / Watch:"),
        Line::from("    Esc          stop and return to browser"),
        Line::from("    Ctrl-C       same as Esc"),
        Line::from(""),
        Line::from("    q  quit       ?  this help - any key dismisses"),
    ];
